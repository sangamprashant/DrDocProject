      ...
      {!token ? (
        <div class="bg_color">
          <section class="  banner">
            ...
            >
              <div class="about-details banner-text">
                <p>
          ...
          <section id="get-started" class="padd-section text-center">
            <div class="container">
              <div class="section-title text-center">
                <p class="separator">WHAT WE DO FOR YOU</p>
              ...
              <div class="row ">
                ...
                <div class="col-md-7 col-lg-5">
                  <div class="about-content">
                    <p class="separator">ABOUT OUR APP</p>
                    <h2>
                      <strong>
                        Assuring you of
                        <br /> the{" "}
              ...
              >
                <div class="col-md-6 col-md-4 col-lg-3">
                  <div class="team-block bottom">
                    <img src={prashant} class="img-responsive" alt="img" />
                ...
                <div class="col-md-6 col-md-4 col-lg-3">
                  <div class="team-block bottom">
                    <img src={muskaan} class="img-responsive" alt="img" />
                    <div class="team-content">
                      <ul
                        class="list-unstyled"
                        style={{
          ...
          <section id="contact" class="padd-section">
            <div class="container">
              <div class="section-title text-center">
                ...
                <p class="separator">Send us the update and error problem.</p>
              </div>
