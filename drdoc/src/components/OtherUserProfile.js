        ...
        <>
          <div class="home">
            <div class="user-header-wrapper">
              <div class="user-header-inner" style={{display:"flex" ,justifyContent:"center"}}>
                <div class="uh-left-user">
                  <div class="uh-image">
                    <img
                ...
                <div class="uh-right-user">
                  ...
                  <div class="user-info-home">
                    <button class="btn-home">Upload</button>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div key={pics._id}>
                      <div id="img1" class="image-wrapper">
                        <div id="iov1" class="img-overlay-wrapper">
                          <div class="img-btns">
                            <p>
                              465 <i class="uil uil-heart-alt"></i> &nbsp&nbsp
                              25 <i class="uil uil-comment"></i>
                            </p>
                          </div>
